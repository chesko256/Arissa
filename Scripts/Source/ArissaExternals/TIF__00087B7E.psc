...
Scriptname TIF__00087B7E Extends TopicInfo Hidden
...
Target4Alias.GetReference().Enable()
Actor Target4 = Target4Alias.GetReference() as Actor
Target4.Resurrect()
...
ReferenceAlias Property Target4Alias  Auto
