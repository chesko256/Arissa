...
Scriptname QF_Favor054_0007172A Extends Quest Hidden
...
Alias_QuestGiver.GetActorReference().RemoveFromFaction(Favor154QuestGiverFaction)

If Alias_QuestGiver.GetActorRef().GetRelationshipRank(Game.GetPlayer()) == 0
  Alias_QuestGiver.GetActorReference().SetRelationshipRank(Game.GetPlayer(), 1)
ElseIf Alias_QuestGiver.GetActorRef().GetRelationshipRank(Game.GetPlayer()) == 1
