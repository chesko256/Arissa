...
Scriptname SF_BardSongsInstrumentalDrum_00107511 Extends Scene Hidden
...
Function Fragment_3()
;BEGIN CODE
;WARNING: Unable to load fragment source from function Fragment_3 in script SF_BardSongsInstrumentalDrum_00107511
;Source NOT loaded
;END CODE
EndFunction
;END FRAGMENT
