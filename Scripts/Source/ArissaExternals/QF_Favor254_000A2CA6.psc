...
Scriptname QF_Favor254_000A2CA6 Extends Quest Hidden
...
Alias_QuestGiver.GetActorReference().RemoveFromFaction(Favor254QuestGiverFaction)
...
If FavorJarlsMakeFriends.GetStageDone(55)
  SetStage(20)
EndIf
;END CODE
EndFunction
...
FavorJarlsMakeFriends.SetStage(50)

;Player already has the house
If HousePurchase.WindhelmHouseVar >= 1
  SetStage(15)
EndIf
;END CODE
EndFunction
