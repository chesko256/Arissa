...
Scriptname TIF__00087B7F Extends TopicInfo Hidden
...
Target5Alias.GetReference().Enable()
Actor Target5 = Target5Alias.GetReference() as Actor
Target5.Resurrect()
...
ReferenceAlias Property Target5Alias  Auto
