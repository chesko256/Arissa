...
Scriptname TIF__00087B84 Extends TopicInfo Hidden
...
Target10Alias.GetReference().Enable()
Actor Target10 = Target10Alias.GetReference() as Actor
Target10.Resurrect()
...
ReferenceAlias Property Target10Alias  Auto
