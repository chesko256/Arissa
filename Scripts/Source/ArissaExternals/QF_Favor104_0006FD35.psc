...
Scriptname QF_Favor104_0006FD35 Extends Quest Hidden
...
Alias_QuestGiver.GetActorReference().RemoveFromFaction(Favor104QuestGiverFaction)

If (Alias_QuestGiver.GetActorReference().GetRelationshipRank(Game.GetPlayer()) < 1)
