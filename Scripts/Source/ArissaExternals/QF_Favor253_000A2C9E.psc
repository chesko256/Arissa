...
Scriptname QF_Favor253_000A2C9E Extends Quest Hidden
...
Alias_QuestGiver.GetActorReference().RemoveFromFaction(Favor253QuestGiverFaction)
...
If FavorJarlsMakeFriends.GetStageDone(45)
  SetStage(20)
EndIf
;END CODE
EndFunction
...
FavorJarlsMakeFriends.SetStage(40)
