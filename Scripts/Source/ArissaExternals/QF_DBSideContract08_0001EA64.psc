...
Scriptname QF_DBSideContract08_0001EA64 Extends Quest Hidden

;BEGIN ALIAS PROPERTY DBAnoriathAlias
;ALIAS PROPERTY TYPE REFERENCEALIAS
REFERENCEALIAS Property Alias_DBAnoriathAlias Auto
;END ALIAS PROPERTY
...
Function Fragment_0()
;BEGIN AUTOCAST TYPE DBSideContract08Script
Quest __temp = self as Quest
DBSideContract08Script kmyQuest = __temp as DBSideContract08Script
;END AUTOCAST
;BEGIN CODE
...
if DBScript.pAnoriathAlreadyDead == 1
     SetStage (20) 
endif
;END CODE
EndFunction
