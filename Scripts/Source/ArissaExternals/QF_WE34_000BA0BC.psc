...
Scriptname QF_WE34_000BA0BC Extends Quest Hidden
...
alias_Thalmor1.GetReference().DeleteWhenAble()
alias_Thalmor2.GetReference().DeleteWhenAble()
alias_Thalmor3.GetReference().DeleteWhenAble()
;END CODE
EndFunction
;END FRAGMENT
...
;END AUTOCAST
;BEGIN CODE
; debug.trace(self + "stage 0 adding Letter to Thalmor1")
Alias_Thalmor1.GetReference().addItem(Alias_Letter.GetReference())
;END CODE
EndFunction
;END FRAGMENT
