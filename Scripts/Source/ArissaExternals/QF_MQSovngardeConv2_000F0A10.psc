...
Scriptname QF_MQSovngardeConv2_000F0A10 Extends Quest Hidden
...
;BEGIN CODE
; first info
; allow other conversations to run now
MQ304.HallofHeroesCombatFlag = true
;END CODE
EndFunction
;END FRAGMENT
...
MQ304Script Property MQ304  Auto  
