...
;BEGIN ALIAS PROPERTY CaveEntrance
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_CaveEntrance Auto
;END ALIAS PROPERTY

;BEGIN ALIAS PROPERTY CaveBlock
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_CaveBlock Auto
;END ALIAS PROPERTY
...
Alias_CaveEntrance.GetRef().Enable()
Alias_CaveBlock.GetRef().Disable()
;END CODE
EndFunction
;END FRAGMENT
